...
function StatusBadge({ status }) {
  const cfg = statusConfig[status] || { dot: "#94A3B8", bg: "rgba(148,163,184,0.12)", border: "rgba(148,163,184,0.2)", text: "#94A3B8", label: status };
  return (
  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, -apple-system, sans-serif", color: "#E2E8F0", minHeight: "100%" }}>
      ...
      <div style={{ marginBottom: 28, display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
        <div>
          ...
          <p style={{ color: "#64748B", fontSize: 13.5, margin: 0, letterSpacing: "0.01em" }}>
            All open and in-progress tasks assigned to you.
          </p>
        </div>
      ...
      <div style={{ background: "#111827", borderRadius: 16, border: "1px solid rgba(255,255,255,0.06)", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.35)", position: "relative" }}>
        {/* Top accent line */}
        <div style={{ height: 3, background: "linear-gradient(90deg, #F59E0B 0%, #6366F1 60%, transparent 100%)", position: "absolute", top: 0, left: 0, right: 0 }} />
        ...
        {tasks.length === 0 ? (
          <div style={{ padding: "56px 24px", textAlign: "center" }}>
            <div style={{ display: "inline-flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
              ...
              <div style={{ color: "#E2E8F0", fontWeight: 600, marginBottom: 4 }}>No pending tasks</div>
              <div style={{ color: "#64748B", fontSize: 13 }}>Active and pending tasks assigned to you will appear here.</div>
            </div>
          </div>
        ) : (
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14, minWidth: 700 }}>
              <thead>
                <tr style={{ background: "#0D1421", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                  {["Task", "Description", "Priority", "Status", "Company", "Assigned By", "Due Date"].map((col, i) => (
                ...
                {tasks.map((task, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Due Date */}
                      <td style={{ padding: "14px 20px", fontFamily: "'JetBrains Mono','Fira Code',monospace", fontSize: 12, color: "#94A3B8", whiteSpace: "nowrap" }}>
                        {task.dueDate
