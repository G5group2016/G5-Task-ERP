...
const CompletedTasks = () => {
  ...
  const loadTasks = async () => {
    ...
    const filtered = data.tasks.filter((task) => task.status === "COMPLETED");
    setTasks(filtered);
    setLoading(false);
  };
    ...
    >
      ...
      <div style={{ marginBottom: 28, display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
        <div>
          ...
          <p style={{ color: "#64748B", fontSize: 13.5, margin: 0, letterSpacing: "0.01em" }}>
            Review all tasks that have been finished and closed out.
          </p>
        </div>
      ...
      >
        ...
        <div
          style={{
            height: 3,
            background: "linear-gradient(90deg, #10B981 0%, #6366F1 60%, transparent 100%)",
            position: "absolute",
            top: 0,
            left: 0,
            right: 0,
