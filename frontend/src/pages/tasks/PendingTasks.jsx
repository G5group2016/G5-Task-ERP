        ...
        >
          ...
          <div>
            ...
            <div style={{ color: "#64748B", fontSize: 13 }}>
              Active and pending tasks assigned to your team will appear here.
            </div>
          </div>
        </div>
      </td>
    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ color: "#64748B", fontSize: 13.5, margin: 0, letterSpacing: "0.01em" }}>
            All open and in-progress tasks assigned across your team.
          </p>
        </div>
      ...
      >
        ...
        <div
          style={{
            height: 3,
            background: "linear-gradient(90deg, #F59E0B 0%, #6366F1 60%, transparent 100%)",
            position: "absolute",
            top: 0,
            left: 0,
            right: 0,
